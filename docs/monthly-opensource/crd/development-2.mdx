...
다행히 Chrome DevTools 프론트엔드는 Chromium 프로젝트의 일부이며, [공식 ChromeDevTools/devtools-frontend 저장소](https://github.com/ChromeDevTools/devtools-frontend)에 공개돼 있다. CRD에서는 그 포크인 [ohah/devtools-frontend](https://github.com/ohah/devtools-frontend)를 서브모듈로 가져와 Inspector에 iframe으로 임베드하는 방식을 택했다. [CRD의 서브모듈 설정](https://github.com/ohah/chrome-remote-devtools/blob/d5e443d031a076ce7b6fa91f5587c0a2e59d97ea/.gitmodules)에서도 사용하는 포크를 확인할 수 있다.
