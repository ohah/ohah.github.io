---
title: "3-10. React Native 플랫폼과 최종 성능"
date: 2026-04-07
---

# 3-10. React Native 플랫폼과 최종 성능

> **기간**: 2026년 3월 27일 ~ 4월 7일
> **커밋**: Phase 20, 24 관련 ~30개
> **핵심**: `--platform=react-native` 프리셋, Metro 호환, Hermes 구문 검증, Rolldown 비교, ZTS 속도
...
ZTS는 학습 프로젝트로 시작했다. 20일이 지난 지금, **Test262 100%, kangax ES5 99%, Hermes 구문 검증 통과, esbuild 1.24배 성능**의 트랜스파일러/번들러가 됐다.

남은 과제(CSS 번들링, 플러그인 고도화, NAPI 바인딩)가 있지만, 핵심은 증명됐다: **Zig로 만든 JS/TS 트랜스파일러는 빠르고, React Native 번들러로 쓸 수 있다.**
