...
import { getSidebarDataGroup } from "./hooks/useSidebar.js";
import { isActive } from "./route.js";
...
describe('getSidebarDataGroup', ()=>{
    it('when using "/"', async ()=>{
        ...
        }, '/guide/getting-started')).toMatchInlineSnapshot(`
      [
        {
          "link": "/guide/getting-started",
          "text": "Getting Started",
    ...
    it('when using api-extractor', async ()=>{
        ...
        }, '/api/react.use.html')).toMatchInlineSnapshot(`
      [
        {
          "link": "/api/react.use",
          "text": "react.use",
...
describe('isActive', ()=>{
    it('pass cases', ()=>{
        ...
        for (const route of routes)for (const route2 of routes)expect(isActive(route, route2)).toBeTruthy();
    });
    it('failed cases', ()=>{
