...
import { isActive, matchPath, pathnameToRouteService } from "./route.js";
...
describe('isActive', ()=>{
    ...
    it('should handle hash and search parameters correctly', ()=>{
        ...
        expect(isActive('/api/config', '/api/config.html?query=value#hash')).toBe(true);
...
describe('pathnameToRouteService', ()=>{
    it('0. /api/config', ()=>{
        ...
        expect(pathnameToRouteService(pathname)?.path).toMatchInlineSnapshot('"/api/config/"');
    });
    ...
    it('5. /', ()=>{
        ...
        expect(pathnameToRouteService('/index.md')?.path).toMatchInlineSnapshot("undefined");
    });
    ...
    it('10. Case-insensitive route matching', ()=>{
        expect(pathnameToRouteService('/API/CONFIG')?.path).toMatchInlineSnapshot('"/api/config/"');
        expect(pathnameToRouteService('/Api/Config')?.path).toMatchInlineSnapshot('"/api/config/"');
        expect(pathnameToRouteService('/API/CONFIG.html')?.path).toMatchInlineSnapshot('"/api/config/"');
        expect(pathnameToRouteService('/API/CONFIG/')?.path).toMatchInlineSnapshot('"/api/config/"');
        expect(pathnameToRouteService('/API/CONFIG/index.html')?.path).toMatchInlineSnapshot('"/api/config/"');
        expect(pathnameToRouteService('/api/CONFIG#hash')?.path).toMatchInlineSnapshot('"/api/config/"');
    });
});
