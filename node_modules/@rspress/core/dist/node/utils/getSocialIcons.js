...
function getSocialIcons(socialLinks = []) {
    ...
    for (const link of socialLinks)if ('string' == typeof link.icon) {
        ...
        if (!pathContent) throw createError(`Icon "${link.icon}" not found in preset icons.`);
